...
describe('Manager', () => {
  describe('InitializeJs', () => {
    ...
    test("Can set name attribute with constructor", () => {
      const name = "Andy";
      const cb = new manager(name, "Manager", 23, "andy@gmail.com", 555, "athaight");
      expect(cb.name).toBe(name);
    });
    test("Can set role attribute with constructor", () => {
      const role = "Manager";
      const cb = new manager("Andy", role, 23, "andy@gmail.com", 555, "athaight");
      expect(cb.role).toBe(role);
    });
    test("Can set id attribute with constructor", () => {
      const id = 23;
      const cb = new manager("Andy", "Manager", id, "andy@gmail.com", 555, "athaight");
      expect(cb.id).toBe(id);
    });
    test("Can set email attribute with constructor", () => {
      const email = "andy@gmail.com";
      const cb = new manager("Andy", "Manager", 23, email, 555, "athaight");
  ...
  describe("getInfo", () => {
    test("Does getName() method get name?", () => {
      const name = "Andy";
      const cb = new manager(name, "Manager", 23, "andy@gmail.com");
    ...
    test("Does getofficeNumber() method get mail?", () => {
        const officeNumber = "Andy@gmail.com";
        const cb = new manager("Andy", "Manager", 23, email, 555, "athaight");
        expect(cb.getofficeNumber()).toBe(getofficeNumber);
      });
    test("Does getGitHub() method get GitHub username?", () => {
      const cb = new manager("Andy", "Manager", 23, "andy@gmail.com", 555, github);

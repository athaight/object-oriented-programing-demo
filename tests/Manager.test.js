...
describe('Manager', () => {
  describe('InitializeJs', () => {
    ...
    test("Can set id attribute with constructor", () => {
      const id = 23;
      const cb = new manager("Tucker", "Manager", id, "Tucker@gmail.com", 555, "tbeauchamp");
    ...
    test("Can set officeNumber attribute with constructor", () => {
      ...
      const cb = new manager("Tucker", "Manager", 23, "Tucker@gmail.com", officeNumber, "tbeauchamp");
  ...
  describe("getInfo", () => {
    ...
    test("Does getEmail() method get email?", () => {
      const email = "Tucker@gmail.com";
      const cb = new manager("Tucker", "Manager", 23, email, 555, "tbeauchamp");
    ...
    test("Does getGitHub() method get GitHub username?", () => {
      const github = "tbeauchamp"; 
      const cb = new manager("Tucker", "Manager", 23, "Tucker@gmail.com", 555, github);
